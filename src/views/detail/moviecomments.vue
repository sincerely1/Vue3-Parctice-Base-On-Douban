    ...
    <div class="scroll-wrap">
      <div class="comment-item" v-for="item in detailData.list || []">
        <div class="top-content">
          ...
          <div v-if="item.rating && item.rating.value" class="rankstar"><span class="rank-text">看过</span>
...
const title = computed(() => store.detailTitle);
const incommentList = computed(() => store.commentList);
